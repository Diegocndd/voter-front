    ...
    <div>
      ...
      {!idPassword ? (
        <div id="main-content-forgot-password">
          ...
          />
          {errorSendEmail ? (
            <p id="error-email-password">{ERROR_SEND_EMAIL}</p>
          ) : null}
        ...
        <div id="main-content-forgot-password">
          ...
          />
          {errorChangePassword ? (
            <p id="error-email-password">
              Ocorreu um erro ao modificar sua senha! Verifique se você está no
              link correto.
            </p>
          ) : null}
          {errorDifferentPassword ? (
            <p id="error-email-password">As senhas não são iguais!</p>
          ) : null}
          {errorLengthPassword ? (
            <p id="error-email-password">
              A senha não pode possuir menos de 6 caracteres!
            </p>
          ) : null}
          {errorNumericPassword ? (
            <p id="error-email-password">
              A senha deve possuir pelo menos um dígito numérico!
            </p>
          ) : null}
